...
public class Aboardgame implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		dialogVPanel.add(new HTML("<b>Sending guess to the server:</b>"));
		...
		class AboardgameHandler implements ClickHandler, KeyUpHandler {
			...
			private void sendNameToServer() {
				...
				if (!FieldVerifier.isValidGuess(textToServer)) {
					errorLabel.setText("Please enter a number (0-9)");
					return;
				}
    ...
    private void doSeriousInit() {
        TicTacToeBoard board = new TicTacToeBoardWidget();
